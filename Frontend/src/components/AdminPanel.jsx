...
const tags = supportedTags;
  const onSubmit = async (data) => {
    try {
        ...
        console.error(err);
        const message = err?.response?.data?.message || err?.response?.data || "Failed to create problem. Please try again.";
        alert(typeof message === "string" ? message : "Failed to create problem. Please try again.");
    } finally {
